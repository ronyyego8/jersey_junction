from jersey_app.forms import LoginForm, PasswordChangeForm, PasswordResetForm, SetPasswordForm
...
urlpatterns = [
    ...
    path('accounts/logout/', auth_views.LogoutView.as_view(next_page='jersey_app:login'), name="logout"),
